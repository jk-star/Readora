    ...
    return (
        <div className="min-h-screen bg-[#f8f6f1]">
            ...
            <header className="border-b border-gray-200 bg-white">
                <div className="mx-auto flex h-16 max-w-4xl items-center justify-between px-4 relative">
            ...
            >
                ...
                <article className={`mt-8 ${fontSize} mx-auto max-w-3xl`}>
                    ...
                    <div className={`mt-10 space-y-6 ${fontSize} leading-8 text-gray-700`}>
